    ...
    public static void run() {
        ...
        try (Connection conn = DatabaseManager.getConnection();
            ...
            if (isEmpty(st, "stock_movement")) {
                st.executeUpdate("""
                    INSERT INTO stock_movement (product_id, warehouse_id, po_id, movement_type, quantity, unit_price, unit_cost, reason) VALUES
                    (1, 1, NULL, 'IN', 20, 12.50, 12.50, 'Initial Inventory Stock In'),
                    (2, 1, NULL, 'IN', 100, 4.25, 4.25, 'Initial Inventory Stock In'),
                    (3, 1, 2, 'IN', 5, 89.99, 89.99, 'Received against PO #2'),
                    (4, 2, NULL, 'IN', 250, 2.10, 2.10, 'Initial Inventory Stock In'),
                    (5, 2, 2, 'IN', 10, 24.75, 24.75, 'Received against PO #2'),
                    (1, 1, NULL, 'OUT', 5, 19.99, 12.50, 'Sold 5 units to Apex Enterprises @ $19.99/unit'),
                    (2, 1, NULL, 'OUT', 20, 7.50, 4.25, 'Sold 20 units to Byte Solutions @ $7.50/unit'),
                    (3, 1, NULL, 'OUT', 2, 139.99, 89.99, 'Sold 2 units to Modern Tech Hub @ $139.99/unit'),
                    (4, 2, NULL, 'OUT', 50, 4.50, 2.10, 'Sold 50 units to City Academy @ $4.50/unit'),
                    (5, 2, NULL, 'OUT', 6, 39.99, 24.75, 'Sold 6 units to Creative Studios @ $39.99/unit')
                    """);
            }
