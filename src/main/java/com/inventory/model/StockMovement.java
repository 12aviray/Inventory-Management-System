...
public class StockMovement {
    ...
    private double unitCost; // cost basis at the time of this movement (for COGS)
    ...
    public StockMovement(int productId, int warehouseId, Integer poId, String movementType, int quantity, String reason) {
        this(productId, warehouseId, poId, movementType, quantity, 0.0, 0.0, reason);
    }
    ...
    public StockMovement(int productId, int warehouseId, Integer poId, String movementType, int quantity, double unitPrice, String reason) {
        this(productId, warehouseId, poId, movementType, quantity, unitPrice, 0.0, reason);
    }

    public StockMovement(int productId, int warehouseId, Integer poId, String movementType, int quantity,
                          double unitPrice, double unitCost, String reason) {
