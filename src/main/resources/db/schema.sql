...
CREATE TABLE IF NOT EXISTS stock_movement (
    ...
    -- unit_price: the transaction price (sale price for OUT, purchase price for IN).
    -- unit_cost: the product's cost basis *at the time of this movement* — this is
    -- what COGS/profit reports must use instead of joining to product.unit_cost,
    -- so that a later change to a product's current cost never rewrites the
    -- profit history of past sales.
